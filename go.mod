...
require (
	...
	github.com/jenkins-x/go-scm v1.11.16 // indirect
...
replace (
	...
	github.com/jenkins-x/go-scm => github.com/jenkins-x/go-scm v1.11.6
	// See: https://github.com/google/go-cloud/issues/3114
	github.com/mattn/go-ieproxy => github.com/mattn/go-ieproxy v0.0.1
	// Required for make build to work, but would be good to upgrade them in a separate PR
